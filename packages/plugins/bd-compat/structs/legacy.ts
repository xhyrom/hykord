 ...
 * @memberof BdApi
 */
const React = Hykord.Webpack.Common.React;
 ...
 * @memberof BdApi
 */
const ReactDOM = Hykord.Webpack.Common.ReactDOM;
...
function injectCSS(id, css) {
    Hykord.Patcher.patchCss(css, id);
}
...
function showConfirmationModal(title, content, options = {}) {
    // TODO: types
    // @ts-expect-error MISSING TYPES 
    return Hykord.Components.Alerts.show({
        title: title,
        body: content,
        ...options
    })
...
function showToast(content, options = {}) {
    // TODO: types
    // @ts-expect-error MISSING TYPES 
    return Hykord.Components.Toasts.show({
        message: content,
        // @ts-expect-error MISSING TYPES
        id: options.id || Hykord.Components.Toasts.genId(),
        ...options
    })
}
...
function findModule(filter) {
    return Hykord.Webpack.getModule(filter);
}
...
function findAllModules(filter) {
    return Hykord.Webpack.getAllModules(filter);
}
...
function findModuleByProps(...props) {
    return Hykord.Webpack.findByProps(...props);
}
...
function findModuleByPrototypes(...protos) {
    return Hykord.Webpack.findByPrototypeFields(...protos);
}
